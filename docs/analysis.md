...
| **1. Read**           | Reads the input file.                   | `"I am a optimist , 1E (hex)"` |                   |                          |
| **2. Clean**          | Cleans punctuation and quotation marks. | `"I am a optimist, 1E (hex)"`  |                   |                          |
| **3. Grammar**        | Checks and applies “a→an”.              | `"I am an optimist, 1E (hex)"` |                   |                          |
| **4. Numbers**        | Converts `(hex)` and `(bin)`.           | `"I am an optimist, 30"`       |                   |                          |
